      ...
      <div class="col-sm-12 bg-light text-dark">
        <table id="resultTable" class="table table-striped">
          <thead>
            ...
            <tr>
              <th colspan="6">
                <input id="titleFilterInput" type="text" class="form-control mr-sm-2" placeholder="Search for titles.." oninput="getTitle()" autocomplete="off" autocorrect="off" autocapitalize="off"/>
              </th>
            </tr>
            <tr>
